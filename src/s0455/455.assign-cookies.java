...
class Main {
    ...
    public static void main(String[] args) {
        cases().forEach(c -> {
            int res = new Solution().findContentChildren(c.g, c.s);
    ...
    private static List<Case> cases() {
        ...
        cases.add(new Case(new int[]{1,2, 3}, new int[]{1, 1}, 1));
        cases.add(new Case(new int[]{1, 2}, new int[]{1, 2, 3},2 ));
...
class Case {
    ...
    public Case(int[] g, int[] s, int expected) {
        this.g = g;
        this.s = s;
