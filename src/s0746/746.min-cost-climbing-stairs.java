...
class Main {
    ...
    public static void main(String[] args) {
        cases().forEach(c -> {
            int res = new Solution().minCostClimbingStairs(c.cost);
    ...
    private static List<Case> cases() {
        ...
        cases.add(new Case(new int[]{10, 15, 20},  15));
        cases.add(new Case(new int[]{1, 100, 1, 1, 1, 100, 1, 1, 100, 1},  6));
...
class Case {
    ...
    public Case(int[] cost, int expected) {
        this.cost = cost;
