...
class Main {
    ...
    public static void main(String[] args) {
        cases().forEach(c -> {
            List<List<Integer>> res = new Solution().levelOrderBottom(c.root);
    ...
    private static List<Case> cases() {
        ...
        List<List<Integer>> e1 = Arrays.asList(Arrays.asList(15, 7), Arrays.asList(9, 20), Collections.singletonList(3));
        ...
        cases.add(new Case(t1, Arrays.asList(Arrays.asList(8, 9, 10, 11, 12, 13, 14, 15), Arrays.asList(4, 5, 6, 7),
